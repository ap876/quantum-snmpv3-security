...
"""
SNMPv3 agent (USM) + QKD KMS integration + PROXY to net-snmpd (v2c public at 127.0.0.1:161)
Front on :50161, HTTP /kms on :8080. Supports GET/NEXT/BULK and forwards to local snmpd.
"""
...
cmdrsp.SetCommandResponder(snmpEngine,  snmpContext)   #SET will fail(backend RO)
    ...
    def do_POST(self):
        ...
        if path == "/qkd":
            ...
            try:
                ...
                logging.info("QKD /qkd greška: %s", e); return self._send_text(500, "ERROR")
