...
def run_snmp_get(agent_host: str, agent_port: int, user: str, auth_pass: str, priv_key_bytes: bytes, oid_str: str) -> None:
...
def main() -> None:
    recent_ids: Deque[str] = deque(maxlen=DEDUP_WINDOW)
